        ...
        return (
            <ScrollView style={pageContainerStyle}>
                <View style={styles.regContainer}>
                    <Text style={styles.regContainer.headerText}>Entry Your 4 digit code</Text>
                    <View style={styles.logoSection}>
                        {/* <Text>Phone Number</Text> */}

                        <Image style={styles.logoSection.logoImage}
                    ...
                    />
                    <Text style={{textAlign: "center", color:BKColor.textColor2}} >{errorMessage}</Text>

                    <View style={styles.loginFooter}>
                        <Text style={styles.loginFooter.textLeft}>Did you don’t get code? </Text>
